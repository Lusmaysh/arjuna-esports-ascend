  ...
  const faqs = [
    {
      ...
      answer: "Klik tombol 'Daftar Sekarang' pada kartu turnamen apa pun dan isi formulir pendaftaran. Pastikan untuk menyelesaikan pendaftaran setidaknya 48 jam sebelum turnamen dimulai."
    },
    {
      question: "Apa saja persyaratan teknisnya?",
    ...
    },
    {
      ...
      answer: "Hadiah didistribusikan dalam 7 hari kerja setelah turnamen berakhir. Pemenang akan dihubungi melalui email terdaftar untuk detail pengambilan hadiah."
    },
    {
          ...
          <div className="bg-card/30 border border-border/50 rounded-lg p-8 mb-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground text-sm mb-4">Hubungi jalur dukungan kami</p>
                <Button size="sm" variant="outline">Hubungi Sekarang</Button>
              </div>
            </div>
          </div>
