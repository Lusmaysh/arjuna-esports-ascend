  ...
  const rules = [
    {
      icon: Users,
      title: "Komposisi Tim",
      description: "Setiap tim harus terdiri dari 5 pemain dengan 1 pemain cadangan diperbolehkan."
    },
    {
      icon: Clock,
    ...
    },
    {
      ...
      description: "Semua pemain harus menggunakan perangkat yang disetujui dan mempertahankan koneksi internet yang stabil."
    }
  ];
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              ...
              Harap baca dengan seksama sebelum berpartisipasi.
            </p>
          </div>
          ...
          <div className="bg-card/30 border border-border/50 rounded-lg p-8 mb-8">
            ...
            <div className="space-y-6 text-muted-foreground">
              <div>
                ...
                <p>Semua pemain harus terdaftar 48 jam sebelum turnamen dimulai. ID yang valid dan informasi kontak diperlukan.</p>
              </div>
              
              <div>
                <h3 className="font-semibold text-foreground mb-2">2. Protokol Pertandingan</h3>
                <p>Pemain harus bergabung dengan lobby yang ditentukan 15 menit sebelum waktu pertandingan yang dijadwalkan. Keterlambatan dapat mengakibatkan forfeit.</p>
              </div>
              
              <div>
                <h3 className="font-semibold text-foreground mb-2">3. Masalah Teknis</h3>
                <p>Dalam kasus kesulitan teknis, segera beri tahu petugas turnamen. Pertandingan dapat dijeda atau dijadwal ulang atas kebijaksanaan penyelenggara.</p>
              </div>
              
              <div>
                <h3 className="font-semibold text-foreground mb-2">4. Distribusi Hadiah</h3>
                <p>Hadiah akan didistribusikan dalam waktu 7 hari kerja setelah turnamen selesai. Tanggung jawab pajak berada pada pemenang.</p>
              </div>
            </div>
          </div>
